...
fn empty_struct_is_zero_sized() {
    ...
    let ty = Type::Custom("S".to_string(), Vec::new());
...
fn homogeneous_struct_sums_field_sizes() {
    ...
    let ty = Type::Custom("P".to_string(), Vec::new());
...
fn nested_struct_inherits_alignment() {
    ...
    let ty = Type::Custom("Outer".to_string(), Vec::new());
...
fn enum_with_unit_only_variants_is_discriminant_only() {
    ...
    let ty = Type::Custom("E".to_string(), Vec::new());
