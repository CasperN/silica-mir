...
pub struct FnDecl {
    ...
    pub ret_ty: Type,
    /// Source of the declared return type. When the `-> R` arrow is omitted,
    /// this is generated by HLL desugaring and attributed to the function.
    pub ret_ty_source: SourceInfo,
...
impl FnDecl {
    ...
    pub fn ret_ty_span(&self) -> Span {
        self.ret_ty_source.span()
    }
}
