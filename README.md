...
**Agents:** read [AGENTS.md](./AGENTS.md) first for the compiler map,
grammar, load-bearing invariants, and fixture-writing rules — this
file is the cross-tool convention (Codex, Cursor, Antigravity, Claude
Code all recognize it). Return here for language semantics. Deferred
work lives in [PUNCHLIST.md](./PUNCHLIST.md).
...
Moved to [PUNCHLIST.md](./PUNCHLIST.md).
